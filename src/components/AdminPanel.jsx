...
export default function AdminPanel({ onClose }) {
  ...
  function startEdit(p) {
    ...
    // Scroll ADMIN PANEL itself to TOP
    setTimeout(() => {
      adminPanelRef.current?.scrollTo({
        top: 0,
        behavior: 'smooth',
      })
    }, 50)
  ...
  return (
    ...
    >
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-2xl my-4 sm:my-8 overflow-hidden">
        ...
        {/* HEADER */}
        <div className="flex items-center justify-between gap-3 px-4 sm:px-6 py-4 bg-navy-700 text-white sticky top-0 z-10">
        ...
        {!loggedIn ? (
          ...
          >
            <p className="text-sm text-navy-400 font-marathi">
              {t('admin_login_desc')}
            </p>
          ...
          <div className="p-4 sm:p-6 flex flex-col gap-8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-[11px] text-navy-400/80 mt-1">
                  {t('admin_photo_hint')}
                </p>
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            type="button"
                            onClick={() => startEdit(p)}
                            className="text-xs font-semibold text-royal-500 hover:text-brand-red whitespace-nowrap"
                          >
                            {t('admin_edit')}
                          </button>
                          ...
                          <button
                            ...
                            className="text-xs font-semibold text-brand-red hover:brightness-90 whitespace-nowrap"
                          >
                            {t('admin_delete')}
                          </button>
